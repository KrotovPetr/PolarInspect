...
var port = config_1.PORT !== null && config_1.PORT !== void 0 ? config_1.PORT : 5000;
app.use((0, cors_1["default"])());
app.use(express_1["default"].json());
app.use((0, cookie_parser_1["default"])());
app.use("/", routes_1["default"]);
app.use(errorMiddleware_1.errorMiddlewareFunction);
var connectToDb = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                console.log("Connection to ".concat(config_1.DB_NAME, " has been established successfully."));
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
